...
export const initializeDatabase = async () => {
  try {
    ...
    // Migrations for pregnancy_documents review columns
    try { await db.execAsync(`ALTER TABLE pregnancy_documents ADD COLUMN review_status TEXT DEFAULT 'pending';`); } catch (e) { }
    try { await db.execAsync(`ALTER TABLE pregnancy_documents ADD COLUMN reviewed_at TEXT;`); } catch (e) { }
