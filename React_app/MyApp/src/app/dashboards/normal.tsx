    ...
    return (
        <View style={styles.container}>
            ...
            <SafeAreaView style={styles.safeArea} edges={['top']}>
                ...
                >
                    {/* ── Top Header Bar ── */}
                    <Animated.View entering={FadeInDown.duration(400)} style={[styles.topBar, { justifyContent: 'space-between' }]}>
                        <Image
                            source={require('../../../assets/logo.png')}
                            style={styles.headerLogo}
                            contentFit="contain"
                        />
                        <TouchableOpacity style={styles.qrBtn} onPress={() => setQrModalVisible(true)} activeOpacity={0.8}>
